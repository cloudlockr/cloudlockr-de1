...
# ACDS 15.0 145 win32 2017.11.20.08:30:30
...
alias com {
  echo "\[exec\] com"
  vlog -v2k5 "$QSYS_SIMDIR/submodules/CPEN391_Computer_ARM_A9_HPS.v" -work ARM_A9_HPS
  vlog -v2k5 "$QSYS_SIMDIR/CPEN391_Computer.v"                                       
}
...
alias elab {
  echo "\[exec\] elab"
  eval vsim +access +r -t ps $ELAB_OPTIONS -L work -L ARM_A9_HPS -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -dbg -O2 +access +r -t ps $ELAB_OPTIONS -L work -L ARM_A9_HPS -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver $TOP_LEVEL_NAME
}
